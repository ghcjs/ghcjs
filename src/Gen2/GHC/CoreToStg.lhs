copied from GHC to avoid generating StgLetNoEscape until
properly supported by GHCJS
...
module Gen2.GHC.CoreToStg ( coreToStg, coreExprToStg ) where
...
coreToStgLet let_no_escape bind body = do
    ...
    let
        ...
        no_binder_escapes = False -- LetNoEscape unsupported in GHCJS 
                                  -- isEmptyVarSet (set_of_binders `intersectVarSet` all_escs)
