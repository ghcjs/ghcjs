...
instance Monoid GhcjsSettings where
  mempty = GhcjsSettings False False False Nothing Nothing False False False False Nothing Nothing
  mappend (GhcjsSettings ne1 nn1 nj1 lc1 gh1 dbg1 oo1 nr1 ns1 gb1 ub1)
          (GhcjsSettings ne2 nn2 nj2 lc2 gh2 dbg2 oo2 nr2 ns2 gb2 ub2) =
